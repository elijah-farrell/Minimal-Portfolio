...
import { Mail, Github, Linkedin, Twitter, Download, MapPin, Calendar, Code, Palette, Users, FileDown } from "lucide-react"
      ...
      <div className="border-[#f5f5f5] dark:border-[#1f1f1f] min-h-screen max-w-4xl mx-auto bg-white dark:bg-[#171717] shadow-sm border-r-[19px] border-l-[19px] md:border-r-[31px] md:border-l-[31px] relative" style={{ position: 'relative' }}>
        <DiagonalStripes />
         ...
         <section className="max-w-4xl mx-auto px-6 bg-white dark:bg-[#171717] pt-20 pb-4">
          ...
          {/* Full width border line - only show if Who I Am section is visible */}
          {sectionConfig.about.showWhoIAmSection && (
            <div className="border-b border-[#f5f5f5] dark:border-[#1f1f1f] mb-8 -mx-6"></div>
          )}
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 xl:gap-8 w-full xl:w-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 xl:gap-8 items-start sm:items-center xl:items-center">
                    ...
                    <div className="flex-1 space-y-3 sm:space-y-4 min-w-0 text-center sm:text-left xl:text-left">
                      ...
                      <div className="flex flex-col sm:flex-row xl:flex-row items-center sm:items-start xl:items-start gap-2 sm:gap-4 xl:gap-4 text-xs sm:text-sm text-[#737373] dark:text-[#737373]">
                      ...
                      <p className="text-sm sm:text-base text-[#737373] dark:text-[#737373] leading-relaxed">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        <Button variant="outline" size="sm" className="border-[#f5f5f5] dark:border-[#1f1f1f] bg-transparent whitespace-nowrap text-xs sm:text-sm">
         ...
         <section className="max-w-4xl mx-auto px-6 pt-8 pb-20 border-t border-[#f5f5f5] dark:border-[#1f1f1f] bg-white dark:bg-[#171717]">
           <TextGenerateEffect words="Moments" asHeading={true} staggerDelay={0.15} />
           <DraggableCardDemo />
         </section>

         {/* Education Section */}
        <section className="max-w-4xl mx-auto px-6 pb-12 border-t border-[#f5f5f5] dark:border-[#1f1f1f] bg-white dark:bg-[#171717]">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#737373] dark:text-[#737373] mb-3">
        ...
        {/* Skills Section */}
        <section className="max-w-4xl mx-auto px-6 pt-8 pb-12 border-t border-[#f5f5f5] dark:border-[#1f1f1f] bg-white dark:bg-[#171717]">
        ...
        {sectionConfig.about.showBrandsSection && (
          <section className="max-w-4xl mx-auto px-6 pt-8 pb-12 border-t border-[#f5f5f5] dark:border-[#1f1f1f] bg-white dark:bg-[#171717]">
        ...
        {/* Personal Interests */}
        {sectionConfig.about.showBeyondWorkSection && (
          <section className="max-w-4xl mx-auto px-6 pt-8 pb-12 border-t border-[#f5f5f5] dark:border-[#1f1f1f] bg-white dark:bg-[#171717]">
